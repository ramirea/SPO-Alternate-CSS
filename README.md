...
#### Default Theme
To install the default theme, simply copy over the [cos.tenant.css](blob/master/css/cos.tenant.css) file to your SiteAssets library in Step 2.
...
```
You can overwrite any of the variables contained in [cos.variables.scss](blob/master/scss/cos.variables.scss).
...
2. Open [CSOM-AlternateCSS-ApplyToSiteCollection.ps1](blob/master/CSOM-AlternateCSS-ApplyToSiteCollection.ps1) in PowerShell ISE
